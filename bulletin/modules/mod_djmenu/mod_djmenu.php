<?php 
/**
 * @version $Id: mod_djmenu.php 8 2015-08-11 23:54:46Z szymon $
 * @package DJ-Menu
...
if($params->get('moo',1)) {
	...
	$options = "{wrap: '$wrapper_id', animIn: '$animIn', animOut: '$animOut', animSpeed: '$animSpeed', delay: $delay, direction: '$direction'}";
