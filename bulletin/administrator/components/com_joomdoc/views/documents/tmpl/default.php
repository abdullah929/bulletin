...
if (JOOMDOC_ISJ3){
	...
	echo '<fieldset class="btn-toolbar filter-bar">';
            ...
            if ($this->access->canUpload) {
            	...
            	//note: styling if file input is hard, if we want to keep drag and drop and cross-browser compatibility.
            	//i tried some of solutons for J3 boostrap, but there always were problems... maybe we can style it better in future
                
            	//J3: height is 18+8 = 26
                if (JOOMDOC_ISJ3)
                	echo '<span class="btn" style="vertical-align: middle; line-height: 18px; height: 22px; padding: 1px 14px 3px;">';
                	
               	echo '<label for="upload" style="margin:0px;position:relative;top:2px;margin-right:5px" class="hasTip" title="' . $this->getTooltip('JOOMDOC_DOCUMENTS_UPLOADFILE') . '">' . 
                		JText::_('JOOMDOC_DOCUMENTS_UPLOADFILE') . ': </label>';
                ...
                //class checkbox for J3 boostrap. clear:none for J2.5
